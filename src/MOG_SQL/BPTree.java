...
//
    ...
    public String findNearestPage(Object key) throws ClassNotFoundException, IOException{
    ...
    public static ArrayList<String> getEqual(String tableName, String colName, Object key) throws IOException, ClassNotFoundException {  //Created by Helmy
        ...
        String BPtreePath = "data/" + tableName + "/indices/" + colName + "/Btree.class";
        BPTree tree = (BPTree) DBApp.readObject(BPtreePath);
